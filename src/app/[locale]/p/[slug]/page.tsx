          ...
          <div className={styles.actions}>
            <button 
              ...
              onClick={async () => {
                ...
                setAdding(true);
                try {
      const cartUnitPrice = parseFloat(price) || 0;
      const cartDiscountedPrice = hasDiscount ? parseFloat(String(discountedPrice)) : undefined;
      await addItem({
        ...
        totalPrice: (cartDiscountedPrice ?? cartUnitPrice),
        image: images[0] || '',
